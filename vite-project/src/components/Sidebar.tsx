...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 h-screen hidden md:flex flex-col overflow-hidden bg-white border-r border-gray-200 fixed top-0 left-0 z-40 shadow-lg">
      <div className="p-6 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        ...
        <p className="text-sm mt-1 text-blue-100">Find your perfect products</p>
      </div>
